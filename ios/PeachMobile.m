...
RCT_EXTERN_METHOD(createTransaction:(NSString *)checkoutID paymentBrand:(NSString *)paymentBrand tokenID:(NSString *)tokenID cardCVV:(NSString *)cardCVV resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
